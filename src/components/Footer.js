...
const Footer = () => {
  ...
  const services = [
    { name: 'Soul Portraits', href: '#photography', icon: 'bi-person-fill' },
    { name: 'Eternal Vows', href: '#photography', icon: 'bi-heart-fill' },
    { name: 'Dark Events', href: '#photography', icon: 'bi-calendar-event-fill' },
    { name: 'Shadow Editing', href: '#videography', icon: 'bi-scissors' },
    { name: 'Color Witchcraft', href: '#videography', icon: 'bi-palette-fill' },
    { name: 'Visual Sorcery', href: '#videography', icon: 'bi-magic' }
  ];
      ...
      <Container className="footer-container">
        ...
        <Row className="footer-main">
          ...
          <Col lg={4} md={6} className="mb-5 mb-lg-0">
            <div className="footer-brand">
              ...
              <p className="footer-description">
                Crafting hauntingly beautiful visual narratives that transcend the ordinary, 
                revealing the poetry hidden within shadows and the stories that dwell in darkness.
              </p>

              <div className="footer-social">
                <h5 className="social-title">Follow the Dark Journey</h5>
          ...
          <Col lg={3} md={6} className="mb-5 mb-lg-0">
            <div className="footer-section-wrapper">
              <h5 className="footer-section-title">Dark Arts</h5>
              <ul className="footer-links">
          ...
          <Col lg={3} md={6}>
            <div className="footer-section-wrapper">
              <h5 className="footer-section-title">Reach the Shadows</h5>
              <div className="footer-contact">
                <div className="contact-item">
                  ...
                  <div className="contact-content">
                    <span className="contact-label">Soul Messages</span>
                ...
                <div className="contact-item">
                  ...
                  <div className="contact-content">
                    <span className="contact-label">Dark Whispers</span>
          ...
          <Row className="align-items-center">
            ...
            <Col md={6} className="text-md-end">
              <div className="footer-credits">
                <p>Crafted with <i className="bi bi-heart-fill"></i> in the Shadows</p>
                <div className="footer-badges">
                  <span className="footer-badge">Dark Poetry</span>
                  <span className="footer-badge">Visual Sorcery</span>
                  <span className="footer-badge">Soul Capturing</span>
                </div>
              </div>
            </Col>
          </Row>
